    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="lg:w-96 flex-shrink-0">
            <div class="glass rounded-2xl p-4 sticky top-24">
                <!-- Main Image -->
                <div class="relative aspect-[5/7] bg-dark-700 rounded-xl overflow-hidden mb-3">
                    <img :src="activeImage" alt="" class="w-full h-full object-cover" onerror="cardImgErr(this)">
        ...
        <div class="flex-1 min-w-0 space-y-6">
            ...
            <div class="glass rounded-2xl p-5">
                ...
                <div class="mt-5 space-y-3" x-show="listing.seller_id != <?= (int)$currentUserId ?>">
                    <button @click="buyNow(listing)" :disabled="buying"
                        ...
                        <span x-show="!buying"><?= t('marketplace.buy_now', 'Buy Now') ?></span>
                        <span x-show="buying"><?= t('marketplace.processing', 'Processing...') ?></span>
                    </button>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="glass rounded-2xl p-5" x-show="bids.length > 0">
                ...
                <div class="space-y-2">
                    <template x-for="bid in bids" :key="bid.id">
                        <div class="flex items-center justify-between p-3 bg-dark-800/30 rounded-lg">
                            <div class="flex items-center gap-3">
                                <div class="w-7 h-7 rounded-full bg-dark-700 flex items-center justify-center">
                                    <span class="text-xs font-bold text-dark-300" x-text="(bid.buyer_username || '?').charAt(0).toUpperCase()"></span>
                                </div>
                                <div>
                                    <p class="text-sm text-white" x-text="bid.buyer_username"></p>
