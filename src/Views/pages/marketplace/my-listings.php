        ...
        <template x-for="listing in filteredListings" :key="listing.id">
            <div class="glass rounded-xl p-4 flex items-center gap-4">
                <a :href="'/marketplace/listing/' + listing.id" class="flex-shrink-0">
                    <img :src="listing.first_image || cardImgSrc(listing.card_image_url, listing.card_set_id)" :data-ext-src="listing.card_image_url" class="w-14 h-20 rounded-lg object-cover bg-dark-700" onerror="cardImgErr(this)" loading="lazy">
                </a>
