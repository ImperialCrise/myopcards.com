<div class="max-w-4xl mx-auto px-4 py-8">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900">Create Forum Category</h1>
        <p class="text-gray-600 mt-2">Add a new category to organize forum discussions</p>
    </div>
        ...
        <form method="POST" action="/admin/forum-categories/create" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description" 
                          ...
                          rows="3" 
                          class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                          placeholder="Brief description of what this category is for..."><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                <h3 class="font-medium text-gray-900 mb-2">URL Slug Preview</h3>
                <div class="flex items-center gap-2 text-sm">
                    <span class="text-gray-500">https://myopcards.com/forum/</span>
                    <span id="slug-preview" class="font-mono text-blue-600">category-slug</span>
                </div>
                <p class="text-xs text-gray-500 mt-1">The slug is automatically generated from the category name</p>
            </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateSlugPreview() {
        const name = nameInput.value.toLowerCase()
            .replace(/[^a-z0-9]+/g, '-')
            .replace(/^-|-$/g, '');
        slugPreview.textContent = name || 'category-slug';
    }
